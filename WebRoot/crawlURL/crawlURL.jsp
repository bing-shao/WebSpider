...
<body class="right_body">
	<div class="body">
		<div class="top_subnav" style="margin-top:-5px">网络机器人—龙龙 ＞找网址 ＞网址抓取</div>
		<div class="title">
	...
	<div style="margin-left: 33%;margin-top: 7%;">
	   <div style="margin: 12px;margin-left: 5%;"><label style="font-size: 40;font-family: '微软雅黑'"><b>嗨！来抓一抓网页吧！<b></label></div>
	   <div>
	...
	$("#btn").click(function(){
		...
		$.ajax({
			   ...
			   success : function(response) {
			   		window.location.href="checkURL.jsp";
				}
			});
		});
</script>
